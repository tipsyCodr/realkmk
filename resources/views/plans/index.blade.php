<x-app-layout>
    <div class="flex flex-row p-4 text-center">
        <a class="text-center flex-1 py-4 m-2 hover:bg-gray-500 hover:text-white rounded-lg border text-center"
            ...
            <div class="flex items-center justify-center">
                <img class="w-20" src=" {{ asset(path: 'img/icon/buyer.png') }}" alt="">
            </div>
    ...
    <div class="flex flex-row p-4 text-center">
        ...
        <div class="">
            <a class="text-center flex-1 py-4  m-2  rounded-lg border " href="{{ route('plans.agent') }}">
                <div class="flex items-center justify-center">
                     <img class="w-20" src=" {{ asset('img/icon/agent.png') }}" alt="">
                    <!-- <i class="fa fa-building fa-4x text-green-500"></i> -->
                </div>
                <p class="text-2xl p-4 font-bold">Real Agent Plan</p>
            </a>
        </div>
