<div x-data="{ open: false }" class="flex h-screen bg-gray-50 dark:bg-gray-900"
    ...
    <!-- Mobile sidebar -->
    <!-- Backdrop -->
    <div style="display: none;" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150"
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
            <div
                ...
                <ul class="flex items-center flex-shrink-0 space-x-6">
                    ...
                    <!-- Notification Menu Implementation -->
                    <li class="relative" x-data="{ isNotificationsMenuOpen: false }">
                        ...
                        <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple"
                            ...
                            @keydown.escape="isNotificationsMenuOpen = false" aria-label="Notifications"
                            aria-haspopup="true">
                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path
